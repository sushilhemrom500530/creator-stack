...
import chatbot from "@/src/assets/dashboard/chatbot.svg";
import chatbotlight from "@/src/assets/dashboard/chatbot-light.svg";
import Link from "next/link";
import logo from "@/src/assets/dashboard-logo.svg";
                        ...
                        <nav>
                            {menuLinks?.map((section, sIndex) => (
                                <div key={sIndex} className="space-y-4">
                                    ...
                                    <Link href="/dashboard/kawem-ai">
                                        <button
                                            className={`text-xl font-medium w-full flex items-center gap-3 px-5 py-2 ${pathname === "/dashboard/kawem-ai"
                                                ? activeClass
                                                : inactiveClass
                                                } transition-all duration-300 cursor-pointer`}
                                        >
                                            {pathname === "/dashboard/kawem-ai" ? (
                                                <Image
                                                    src={chatbotlight}
                                                    alt="icon"
                                                    width={20}
                                    ...
                                    {user?.role === "supplier" && (
                                        <Link href="/dashboard/supplier/upgrade-plan">
                                            <button
